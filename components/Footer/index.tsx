            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Jl. PPLI Kp Walahir, Desa Nambo, Kec. Kelapa
                  Nunggal Kab. Bogor—Jawa Barat
                </p>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#05984a" stopOpacity="0.62" />
                <stop offset="1" stopColor="#05984a" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#05984a" stopOpacity="0" />
                <stop offset="1" stopColor="#05984a" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
